...
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_EACH_TEST_METHOD) //dá um drop na base antes de cada teste
public class AnimeControllerIT {
    ...
    void list_ReturnsListOfAnimeInsidePageObject_WhenSuccessful(){
        ...
        PageImpl<Anime> animePage = testRestTemplate.exchange("/animes", HttpMethod.GET, null,
    ...
    @Test
    @DisplayName("findByName returns an empaty list of anime when anime is not found")
    void findByName_ReturnsEmptyListOfAnime_WhenAnimeIsNotFound(){

        List<Anime> animes = testRestTemplate.exchange("/animes/find?name=nomeQueNaoExiste", HttpMethod.GET, null,
                new ParameterizedTypeReference<List<Anime>>(){}).getBody();
